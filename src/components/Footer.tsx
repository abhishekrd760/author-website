                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="md:col-span-2">
                        ...
                        <div className="flex space-x-4">
                            ...
                            <a href="https://instagram.com" className="text-[#C5C6C7] hover:text-[#1F6FEB] transition-colors">
                                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <a href="https://goodreads.com" className="text-[#C5C6C7] hover:text-[#1F6FEB] transition-colors">
                                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
